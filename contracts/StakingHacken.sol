...
/*
    ...
    Эта задача представляет собой смесь некоторых проблем, 
    с которыми мы сталкивались на пути наших аудиторов. 
    Вам нужно найти как можно больше проблем. 
    Результаты могут быть переданы в любой форме, которая вам нравится.
